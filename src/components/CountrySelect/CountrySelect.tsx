...
export const CountrySelect: React.FC<CountrySelectProps<string>> = ({ value, onChange }) => (
  <>
    <MaterialStyles />
    <Autocomplete
...
export const CountrySelectMultiple: React.FC<CountrySelectProps<string[]>> = ({ value, onChange }) => (
  <>
    <MaterialStyles />
    <Autocomplete
      multiple
